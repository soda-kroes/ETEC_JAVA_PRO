...
public class UserDB extends JFrame implements ActionListener,MouseListener{
    ...
    public Connection connection(){
        ...
        try {
            ...
            con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/awt_form","root","");
    ...
    public UserDB() throws HeadlessException {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            if(e.getSource()==btn_add){
                sql = "insert into tb_data (name,age,city) values(?,?,?)";
                ps = connection().prepareStatement(sql);
                ps.setString(1, name);
                ps.setString(2, age);
                ps.setString(3, city);
                ...
                String Age = txt_age.getText();
                String City = txt_city.getText();
                sql="Update tb_data SET name=?,age=?,city=? WHERE id=?";
                ps=connection().prepareStatement(sql);
                ps.setString(1, name);
                ps.setString(2,age);
                ps.setString(3, city);
