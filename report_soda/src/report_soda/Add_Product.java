...
public class Add_Product extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_delete.setBounds(790, 370, 150, 50);
        ...
        jPanel1.add(btn_add);
        btn_add.setBounds(590, 370, 150, 50);
        ...
        btn_reset.setBounds(590, 470, 150, 50);
        ...
        jPanel1.add(btn_pay);
        btn_pay.setBounds(790, 470, 150, 50);
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
     ...
     if(qty_chocolate>0){
         ...
         double price=1.5;
         double amount=price*qty_chocolate;
         Object row[]={name,qty_chocolate,price,amount};
         model.addRow(row);
         try {
             sql="INSERT INTO amazon(name,qty,price,amount) VALUES(?,?,?,?)";
             ps=connection().prepareStatement(sql);
             ps.setString(1,name);
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        try {
            ...
            sql="DELETE FROM amazon WHERE name=?";
            ps=connection().prepareStatement(sql);
            ps.setString(1, name);
            int index=ps.executeUpdate();
             if(index>0){
