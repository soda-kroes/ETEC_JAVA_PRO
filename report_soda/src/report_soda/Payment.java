...
public class Payment extends javax.swing.JFrame {
    ...
    private void cb_discountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_discountActionPerformed
       ...
       double pay=total-disprice;
       txt_payment.setText(df.format(pay)+"$");       
    ...
    private void txt_recieveKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_recieveKeyReleased
            String pay = txt_payment.getText();//20.5$
         pay=pay.substring(0, pay.length()-1);//20.5
    ...
    private void btn_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_printActionPerformed
            ...
            String dis = cb_discount.getSelectedItem().toString();
            dis=dis.substring(0, dis.length()-1);
            double discount = Double.parseDouble(dis);
            
            String disp = txt_disprice.getText();
            ...
            String ret = txt_return.getText();
            ret=ret.substring(0, ret.length()-1);
            double returned = Double.parseDouble(ret);
           
            JasperReport jp = JasperCompileManager.compileReport("report/java11.jrxml");
