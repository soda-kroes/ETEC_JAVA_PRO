...
public class Test3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        percent.setFont(new java.awt.Font("sansserif", 0, 24)); // NOI18N
        percent.setText("%");
        ...
        setSize(new java.awt.Dimension(676, 487));
    ...
    public static void main(String args[]) {
        try {
            ...
            for(int i=0;i<100;i++){
                ...
                obj.percent.setText(Integer.toString(i)+"%");
        ...
        Lodingform form = new Lodingform();
